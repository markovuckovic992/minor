      ...
      <header> 
        ...
        <div id="header-wrapper"> 
          ...
          <div class="row"> 
            <div id="header"> 
              <div id="tagline"> 
                <h1>Have an idea? Share your thoughts with the world!</h1>  
                ...
                <section class="home"> 
                  <div class="group"> 
                    <div class="col span_1_of_4"> 
                      ...
                      <img src="/static/images/icon-black-126.png" style="width:50%" />  
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam rutrum lorem ex, eget iaculis nisl.</p>  
                    ...
                    <div class="col span_1_of_4"> 
                      ...
                      <img src="/static/images/icon-black-100.png" style="width:50%" />  
                      <p>In rutrum orci et dapibus aliquam. Morbi sit amet nulla ornare, hendrerit magna vitae, aliquam.</p>  
                      <input type="button" class="button medium style1 pie" value="More..." /> 
                    </div>  
                    <div class="col span_1_of_4"> 
                      <header> 
                      ...
                      <img src="/static/images/icon-black-151.png" style="width:50%" />  
                    ...
                    <div class="col span_1_of_4"> 
                      ...
                      <img src="/static/images/icon-black-140.png" style="width:50%" />  
        ...
        <div class="content"> 
          ...
          <div class="baseline"> 
            ...
            <ul class="social-links" style="float:right"> 
              <li> 
                <a href="#" rel="nofollow" style="background-image:url('/static/images/facebook.png')" title="Be a fan on Facebook"></a> 
              </li>  
              <li> 
                <a href="#" rel="nofollow" style="background-image:url('/static/images/twitter.png')" title="Follow us on Twitter"></a> 
              </li>  
              <li> 
                <a href="#" style="background-image:url('/static/images/googleplus.png')" title="Circle us on Google+"></a> 
              </li>  
              <li> 
                <a href="#" rel="nofollow" style="background-image:url('/static/images/rss.png')" title="RSS Feed"></a> 
              </li> 
            </ul>  
            <div class="clear"></div> 
          </div> 
